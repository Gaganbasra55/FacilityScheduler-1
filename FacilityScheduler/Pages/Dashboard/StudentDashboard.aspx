<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="StudentDashboard.aspx.cs" Inherits="FacilityScheduler.Pages.StudentDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="w3-center">
        ...
        <div id="NoElements" runat="server">
            <h5>There are no Bookings in 7 days!</h5>
        </div>    

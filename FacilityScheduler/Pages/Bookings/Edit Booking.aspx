<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Edit Booking.aspx.cs" Inherits="FacilityScheduler.Pages.Bookings.Edit_Booking" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="divEdit Booking">
    <p>
        Welcome in  Edit Bookings Page
    </p>
    <p>
        Booking ID:  
        ...
        <asp:Button ID="buttonSaveBooking" runat="server" OnClick="buttonEditBooking_Click" Text="Save Changes" />  
        </p>
    </div>
</asp:Content>
